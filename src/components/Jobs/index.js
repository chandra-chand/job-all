...
class Jobs extends Component {
  ...
  getProfile = async () => {
    ...
    if (response.ok) {
      ...
      this.setState({profileData, apiStatus: apiConstants.success})
    } else {
  ...
  getJobs = async () => {
    ...
    this.setState({jobsStatus: apiConstants.inProgress})
    const jobsUrl = `https://apis.ccbp.in/jobs?employment_type=${employmentType}&minimum_package=${minPackage}&search=${input}`
